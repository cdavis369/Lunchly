...
router.get("/customers_by_name", async function(req, res, next) {
  try {
...
router.get("/best_customers", async function(req, res, next) {
  try {
...
router.get("/:id/", async function(req, res, next) {
  try {
    ...
    const fullName = await Customer.fullName(customer.id);
